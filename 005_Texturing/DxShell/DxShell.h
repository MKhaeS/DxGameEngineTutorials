...
public:
    ...
    static void       Draw              ( int num_indices, int num_instances );
...
private:
    ...
    static inline DxBuffer                           dataBuffers[10]     = {};
    static inline DxShader                           shaders[10]         = {};
    static inline DxTexture                          textures[10]        = {};
