...
public:
    ...
    static void       SetBufferAsVertexBuffer   ( DxBuffer* buffer, int stride );
    static void       SetBufferAsIndexBuffer    ( DxBuffer* buffer );
    ...
    static void       BindShader        ( const DxShader* shader );
    static void       BindVertexBuffer  ( const DxBuffer* buffer );
    static void       BindVertexBuffers ( const DxBuffer* v_buffer, const DxBuffer* inst_buffer );
    static void       BindIndexBuffer   ( const DxBuffer* buffer );
    static void       BindConstants     ( UINT parameter_idx, UINT size, void* data, UINT offset );
    static void       BindCBV           ( UINT parameter_idx, const DxBuffer* buffer );
    static void       BindTextureArray  ( UINT parameter_idx, const DxTexture* texture );
    static void       DrawIndexed       ( int num_indices, int num_instances, int vb_offset, int ib_offset );
    static void       Draw              ( int num_vertices, int num_instances, int vb_offset );
...
private:
    ...
    static inline UINT                               numBuffers         = 0;
